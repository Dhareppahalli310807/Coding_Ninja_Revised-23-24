...
public class Solution {
    ...
    public static void sumOfTwoArrays(int arr1[], int arr2[], int output[]) {
        ...
        int k = output.length - 1; // Index for output
    ...
    public static void main(String[] args) {
        ...
        int[] arr3 = {8, 5, 2};
        int[] arr4 = {1, 3};
        int[] output2 = new int[Math.max(arr3.length, arr4.length) + 1];
        ...
        int[] arr5 = {9, 7, 6, 1};
        int[] arr6 = {4, 5, 9};
        int[] output3 = new int[Math.max(arr5.length, arr6.length) + 1];
        sumOfTwoArrays(arr5, arr6, output3);
        for (int num : output3) {
            System.out.print(num + " ");
        }
    }
