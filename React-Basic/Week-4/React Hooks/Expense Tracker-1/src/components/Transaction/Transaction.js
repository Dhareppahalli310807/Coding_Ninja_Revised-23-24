...
const Transaction = ({ expense, index, onDeleteTransaction, onEditTransaction }) => {
  ...
  return (
    ...
    >
      ...
      <div className={styles.transactionOptions}>
        ...
        >
          <div className={styles.edit} onClick={() => onEditTransaction(index)}>
            <img src={EditImage} height="100%" alt="Edit" />
          </div>
          <div className={styles.delete} onClick={() => onDeleteTransaction(index)}>
